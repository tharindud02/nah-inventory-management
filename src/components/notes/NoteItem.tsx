...
export function NoteItem({
  ...
  return (
    <article
      className={cn(
        "flex gap-4 border-b border-gray-200 pb-6 last:border-b-0",
        className,
      )}
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <time className="mb-2 block text-xs text-gray-500">{timestamp}</time>
        <p className="text-sm leading-relaxed text-gray-700">{content}</p>
        {showActions && (
          <div className="mt-3 flex gap-4">
            <Button variant="ghost" size="sm" className="h-8 gap-1.5 text-gray-600 hover:text-gray-800 hover:bg-gray-50">
